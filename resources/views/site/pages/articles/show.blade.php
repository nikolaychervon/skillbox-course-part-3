...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8 blog-main">
            ...
            <p class="blog-post-meta">January 1, 2014 by <a href="#">Пользователь</a></p>
            <hr>
            <p>
                ...
                используется Lorem Ipsum. Lorem Ipsum - это текст-"рыба", часто используемый в печати и вэб-дизайне.
